...
class DepthSampler(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        while not enough_visible_frames:
            ...
            enough_visible_frames = visible_sum > 2 * (self.num_test_frames + self.num_train_frames) and visible_sum >= 20
        ...
        train_frames, train_depth, train_anno = dataset.get_frames(seq_id, train_frame_ids, seq_info_dict)
        test_frames, test_depth, test_anno = dataset.get_frames(seq_id, test_frame_ids, seq_info_dict)
