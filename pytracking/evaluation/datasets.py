...
dataset_dict = dict(
    ...
    cdtb = DatasetInfo(module=pt % "cdtb", class_name="CDTBDataset", kwargs=dict(split='fuck')),
    ...
    lasot=DatasetInfo(module=pt % "lasot", class_name="LaSOTDataset", kwargs=dict(split='val')),
